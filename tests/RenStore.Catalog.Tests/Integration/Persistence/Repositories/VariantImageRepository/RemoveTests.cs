...
namespace RenStore.Catalog.Tests.Integration.Persistence.Repositories.VariantImageRepository;
...
public class RemoveTests : IAsyncLifetime
{
    ...
    [Fact]
    public async Task Should_Remove_Image_To_Postgres()
    {
        // Arrange
        ...
        var repository = new Catalog.Persistence.Write.Repositories.Postgresql
            .VariantImageRepository(_context, eventStoreMock.Object);
