...
namespace RenStore.Catalog.Tests.Integration.Persistence.Repositories.VariantDetailRepository;
...
public class AddRangeAsyncTests : IAsyncLifetime
{
    ...
    [Fact]
    public async Task Should_Save_Details_To_Postgres()
    {
        // Arrange
        ...
        var repository = new Catalog.Persistence.Write.Repositories.Postgresql
            .VariantDetailRepository(_context, eventStoreMock.Object);
    ...
    public async Task Should_Throw_When_Detail_Is_Null()
    {
        ...
        await Assert.ThrowsAsync<ArgumentNullException>(() => 
            repository.AddRangeAsync(details!, CancellationToken.None));
    }
