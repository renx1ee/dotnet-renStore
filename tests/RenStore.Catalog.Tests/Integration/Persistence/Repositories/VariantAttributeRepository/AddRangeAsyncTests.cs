...
namespace RenStore.Catalog.Tests.Integration.Persistence.Repositories.VariantAttributeRepository;
...
public class AddRangeAsyncTests : IAsyncLifetime
{
    ...
    public async Task Should_Throw_When_Attributes_Are_Null()
    {
        ...
        var repository = new Catalog.Persistence.Write.Repositories.Postgresql
            .VariantAttributeRepository(_context, eventStoreMock.Object);
