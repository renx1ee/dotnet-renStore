...
public class CountryRepository : ICountryRepository
{
    ...
    public async Task<int> CreateAsync(Country country, CancellationToken cancellationToken)
    {
    ...
    public async Task<IEnumerable<Country?>> FindByNameAsync(
        string name,
        CancellationToken cancellationToken,
        ...
        bool descending = false)
    {
        ...
        if (result is null || !result.Any())
            throw new NotFoundException(typeof(Country), name);
