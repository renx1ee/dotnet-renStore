...
internal sealed class ProductArchivedIntegrationEventHandler
    : INotificationHandler<ProductArchivedIntegrationEvent>
{
    private readonly IProductVariantQuery _variantQuery;
    private readonly IProductVariantRepository _variantRepository;

    public ProductArchivedIntegrationEventHandler(
    ...
    public async Task Handle(
        ProductArchivedIntegrationEvent notification, 
