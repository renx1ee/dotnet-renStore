...
public class DeliveryOrderRepository
{
    ...
    public async Task<Guid> CreateAsync(DeliveryOrderEntity deliveryOrder, CancellationToken cancellationToken)
    {
    ...
    public async Task UpdateAsync(DeliveryOrderEntity deliveryOrder, CancellationToken cancellationToken)
    {
    ...
    public async Task<IEnumerable<DeliveryOrderEntity>> FindAllAsync(
        ...
        bool descending = false)
    {
        try
        {
            ...
            return await connection
                .QueryAsync<DeliveryOrderEntity>(sql, new
                {   
                    Count = (int)pageCount,
                    Offset = (int)offset
                });
    ...
    public async Task<DeliveryOrderEntity?> FindByIdAsync(Guid id, CancellationToken cancellationToken)
    {
        if (id == Guid.Empty)
        ...
        try
        {
            ...
            return await connection
                .QueryFirstOrDefaultAsync<DeliveryOrderEntity>(
                    sql, new
                    {
                        Id = id
                    });
    ...
    public async Task<DeliveryOrderEntity?> GetByIdAsync(Guid id, CancellationToken cancellationToken)
    {
        return await this.FindByIdAsync(id, cancellationToken)
               ?? throw new NotFoundException(typeof(DeliveryOrderEntity), id);
    }
    
    public async Task<DeliveryOrderEntity?> FindByOrderIdAsync(Guid orderId, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return await connection
                .QueryFirstOrDefaultAsync<DeliveryOrderEntity>(sql, new
                {   
                    OrderId = orderId
                });
        }
    ...
    public async Task<DeliveryOrderEntity> GetByOrderIdAsync(Guid orderId, CancellationToken cancellationToken)
    {
        return await this.FindByOrderIdAsync(orderId, cancellationToken) 
                     ?? throw new NotFoundException(typeof(DeliveryOrderEntity), orderId);
    }
}