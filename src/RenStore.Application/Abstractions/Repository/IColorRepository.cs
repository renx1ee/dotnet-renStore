...
/// <summary>
/// Repository for working with <see cref="Color"/>.
...
public interface IColorRepository
{
    ...
    Task<IEnumerable<Color>> FindAllAsync(
    ...
    Task<IEnumerable<Color?>> FindByNameAsync(
        string name,
        CancellationToken cancellationToken,
        ColorSortBy sortBy = ColorSortBy.Id,
        uint pageCount = 25,
    ...
    /// <returns>A collection of matching color entities.</returns>
    /// <exception cref="NotFoundException">Thrown when color is not found.</exception>
    Task<IEnumerable<Color?>> GetByNameAsync(
        string name,
        CancellationToken cancellationToken,
        ColorSortBy sortBy = ColorSortBy.Id,
        uint pageCount = 25,
